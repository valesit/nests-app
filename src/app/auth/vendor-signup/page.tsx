...
function VendorSignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        // Redirect to vendor profile setup
    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(to right, rgba(5, 57, 108, 0.3), rgba(0, 200, 150, 0.2))'
        }} />
      </div>
        ...
        <div style={{ width: '100%', maxWidth: '500px' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
              <div>
                <label style={labelStyle}>Password (Minimum 6 characters)</label>
                <input
                  type="password"
                  value={password}
            ...
            >
              {loading ? 'Creating Account...' : 'Next / Continue'}
            </button>
