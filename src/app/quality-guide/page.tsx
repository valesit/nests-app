    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'white', fontFamily: "'Inter', sans-serif" }}>
      ...
      <header style={{ backgroundColor: '#05396c', padding: '1.5rem' }}>
        ...
        <div style={{ maxWidth: '1280px', margin: '2rem auto 0' }}>
          <h1 style={{ color: '#00c896', fontSize: '2rem', fontWeight: 400, marginBottom: '0.5rem' }}>Quality Guide</h1>
          <p style={{ color: 'white', fontSize: '0.875rem' }}>
            <Link href="/" style={{ color: 'white', textDecoration: 'none' }}>Home</Link>
            <span style={{ margin: '0 0.5rem' }}>&gt;</span>
            <span style={{ color: '#00c896' }}>Quality Guide</span>
          </p>
        </div>
      </header>
      ...
      <section style={{ backgroundColor: '#f0f7f4', padding: '3rem 1.5rem' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <h2 style={{ color: '#05396c', fontSize: '1.5rem', fontWeight: 500, fontStyle: 'italic', marginBottom: '1rem' }}>
            Delivering Quality You Can Rely On
          </h2>
          <p style={{ color: '#4b5563', lineHeight: 1.7 }}>
            Quality construction doesn't just mean finishing a project—it means creating something that lasts. Our platform ensures every project meets the highest industry standards through a multi-layered quality framework.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1.5rem', backgroundColor: 'white' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginBottom: '2rem' }}>
            ...
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                <span style={{ backgroundColor: '#05396c', color: 'white', padding: '0.5rem 1rem', borderRadius: '0.25rem', fontSize: '0.875rem', fontWeight: 600 }}>1</span>
                <h3 style={{ color: '#05396c', fontSize: '1.125rem', fontWeight: 600 }}>Pre-Vetting Process</h3>
              </div>
              <p style={{ color: '#4b5563', fontSize: '0.875rem', marginBottom: '0.75rem' }}>Every contractor is assessed on:</p>
            ...
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                <span style={{ backgroundColor: '#05396c', color: 'white', padding: '0.5rem 1rem', borderRadius: '0.25rem', fontSize: '0.875rem', fontWeight: 600 }}>2</span>
                <h3 style={{ color: '#05396c', fontSize: '1.125rem', fontWeight: 600 }}>Quality Grading System</h3>
              </div>
              <p style={{ color: '#4b5563', fontSize: '0.875rem', marginBottom: '0.75rem' }}>We rank contractors on key performance areas:</p>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li><strong>Workmanship:</strong> Attention to detail and finishing</li>
                <li><strong>Punctuality:</strong> Meeting deadlines and milestones</li>
                <li><strong>Communication:</strong> Clear and responsive updates</li>
                <li><strong>Client Ratings:</strong> Verified post-project reviews</li>
              </ul>
            </div>
            ...
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                <span style={{ backgroundColor: '#05396c', color: 'white', padding: '0.5rem 1rem', borderRadius: '0.25rem', fontSize: '0.875rem', fontWeight: 600 }}>3</span>
                <h3 style={{ color: '#05396c', fontSize: '1.125rem', fontWeight: 600 }}>Client Quality Checklist</h3>
              </div>
              <p style={{ color: '#4b5563', fontSize: '0.875rem', marginBottom: '0.75rem' }}>We provide downloadable guides to help you:</p>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li>Ask the right questions before hiring</li>
                <li>Compare proposals beyond just price</li>
                <li>Check materials and contracts</li>
                <li>Conduct mid-project inspections</li>
              </ul>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            ...
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                <span style={{ backgroundColor: '#05396c', color: 'white', padding: '0.5rem 1rem', borderRadius: '0.25rem', fontSize: '0.875rem', fontWeight: 600 }}>4</span>
                <h3 style={{ color: '#05396c', fontSize: '1.125rem', fontWeight: 600 }}>Inspections & Warranties</h3>
              </div>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li>Some contractors include third-party inspections.</li>
                <li>Work warranties protect against defects.</li>
                <li>Clients can request additional inspection services via the platform.</li>
              </ul>
            </div>
            ...
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                <span style={{ backgroundColor: '#05396c', color: 'white', padding: '0.5rem 1rem', borderRadius: '0.25rem', fontSize: '0.875rem', fontWeight: 600 }}>5</span>
                <h3 style={{ color: '#05396c', fontSize: '1.125rem', fontWeight: 600 }}>Sustainable & Green Building</h3>
              </div>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li>Contractors who specialize in eco-friendly construction are highlighted.</li>
                <li>Guides available for energy-efficient upgrades, renewable materials, and green certifications.</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: '0 1.5rem 4rem' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ backgroundColor: '#fef9c3', borderRadius: '0.5rem', padding: '2rem' }}>
            <h3 style={{ color: '#05396c', fontSize: '1.25rem', fontWeight: 600, marginBottom: '1rem' }}>Outcome</h3>
            <p style={{ color: '#4b5563', marginBottom: '1.5rem' }}>
              By following our Quality Guide, clients achieve long-term savings, higher property values, and peace of mind knowing their project was built to last.
            </p>
            <Link href="#" style={{ display: 'inline-block', padding: '0.75rem 1.5rem', backgroundColor: '#00c896', color: 'white', borderRadius: '0.375rem', textDecoration: 'none', fontSize: '0.875rem', fontWeight: 500 }}>
              Download our free Quality Checklist
            </Link>
          </div>
        </div>
      </section>
