    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'white', fontFamily: "'Inter', sans-serif" }}>
      ...
      <header style={{ backgroundColor: '#05396c', padding: '1.5rem' }}>
        ...
        <div style={{ maxWidth: '1280px', margin: '2rem auto 0' }}>
          <h1 style={{ color: '#00c896', fontSize: '2rem', fontWeight: 400, marginBottom: '0.5rem' }}>Resources</h1>
          <p style={{ color: 'white', fontSize: '0.875rem' }}>
            <Link href="/" style={{ color: 'white', textDecoration: 'none' }}>Home</Link>
            <span style={{ margin: '0 0.5rem' }}>&gt;</span>
            <span style={{ color: '#00c896' }}>Resources</span>
          </p>
        </div>
      </header>
      ...
      <section style={{ backgroundColor: '#f0f7f4', padding: '3rem 1.5rem' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <h2 style={{ color: '#05396c', fontSize: '1.5rem', fontWeight: 500, fontStyle: 'italic', marginBottom: '1rem' }}>
            Knowledge, Tools, and Insights for Every Contractor
          </h2>
          <p style={{ color: '#4b5563', lineHeight: 1.7 }}>
            Being a contractor isn't just about skills—it's about managing clients, pricing projects, handling compliance, and keeping up with industry trends. That's why we provide contractor-focused resources to help you work smarter, not harder.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1.5rem', backgroundColor: 'white' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <h2 style={{ color: '#05396c', fontSize: '1.25rem', fontWeight: 600, marginBottom: '2rem' }}>Business Growth Resources</h2>
          
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginBottom: '1.5rem' }}>
            {/* Resource 1 */}
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <h3 style={{ color: '#05396c', fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>How to Write Winning Proposals</h3>
              <p style={{ color: '#4b5563', fontSize: '0.875rem', lineHeight: 1.7 }}>
                Learn the art of creating detailed bids that attract clients.
              </p>
            </div>

            {/* Resource 2 */}
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <h3 style={{ color: '#05396c', fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Pricing & Quoting Strategies</h3>
              <p style={{ color: '#4b5563', fontSize: '0.875rem', lineHeight: 1.7 }}>
                Avoid underbidding - discover methods to price competitively while protecting profits.
              </p>
            </div>

            {/* Resource 3 */}
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <h3 style={{ color: '#05396c', fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Portfolio Building Tips</h3>
              <p style={{ color: '#4b5563', fontSize: '0.875rem', lineHeight: 1.7 }}>
                Showcase your past work effectively to secure higher-value projects.
              </p>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginBottom: '1.5rem' }}>
            {/* Resource 4 */}
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <h3 style={{ color: '#05396c', fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Compliance & Legal Guides</h3>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li>Understanding local licensing requirements</li>
                <li>Contractor insurance essentials</li>
                <li>How to draft airtight contracts</li>
                <li>Managing liability and disputes</li>
              </ul>
            </div>

            {/* Resource 5 */}
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <h3 style={{ color: '#05396c', fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Project Management Tools</h3>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li>Free project timeline templates</li>
                <li>Budget and cost calculators</li>
                <li>Communication tips for working with clients</li>
                <li>Guide to using the platform's contractor dashboard</li>
              </ul>
            </div>

            {/* Resource 6 */}
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <h3 style={{ color: '#05396c', fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Skill Development & Training</h3>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li>Safety protocols and best practices</li>
                <li>Eco-friendly and sustainable building techniques</li>
                <li>Digital tools in construction (3D modeling, BIM, AR/VR)</li>
                <li>Upskilling through webinars and online training modules</li>
              </ul>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
            {/* Resource 7 */}
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <h3 style={{ color: '#05396c', fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Marketing & Branding Tips</h3>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li>How to stand out in competitive bids</li>
                <li>Using reviews to build trust</li>
                <li>Leveraging social media for local visibility</li>
                <li>Creating a professional contractor profile</li>
              </ul>
            </div>

            {/* Resource 8 */}
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem' }}>
              <h3 style={{ color: '#05396c', fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Why Resources Matter</h3>
              <ul style={{ color: '#4b5563', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                <li>The best contractors aren't just skilled - they're informed, efficient, and prepared. Our resources give you the edge to not only win jobs but deliver exceptional quality that keeps clients coming back.</li>
              </ul>
            </div>
          </div>
